...
public class BWGItems {
    ...
    public static final Supplier<Item> ALLIUM_ODDION_SOUP = registerSimpleItem("allium_oddion_soup", () -> new Item((new Item.Properties()).stacksTo(1).food((new FoodProperties.Builder()).nutrition(4).saturationModifier(6.5f).usingConvertsTo(Items.BOWL).build())));
